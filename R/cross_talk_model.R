...
dynamicmodel <- function(lambda, y, parms){
  dy1 <- 337.23*(0.00092235-y[2]-y[1]-y[3]-y[4]-y[7])*(0.000079433-y[1]) - (337.23+261.1)*y[1] + 0.000001*y[17] - 0.00005*y[8]
  dy2 <- 146.07*y[1] - 1841*y[2]*(0.0003283-y[3]) + 198.47*y[3] - 1226*y[2]*(5.1288-y[5]-y[8]-y[4]-y[7]-y[6]-y[9]-y[10]-y[13]) +(420+623.17)*y[4] - 3387*y[5]*y[2]+(214.65+605.31)*y[7]-0.00001*(1-y[16])
  ...
  dy17 <- lambda + (1 - 0.01*0.559 - 0.559*0.5*y[14])*(1-y[16]) - 0.1*y[14] - y[17]
  e1t <- 0.000079433+y[1]
  list(c(dy1, dy2, dy3, dy4, dy5, dy6, dy7, dy8, dy9, dy10, dy11, dy12, dy13, dy14, dy15, dy16, dy17, e1t))
  
}

yi <- c(y1 = 0, y2 = 0, y3 = 0, y4 = 0, y5 = 0, y6 = 0, y7 =0, y8 = 0, y9 = 0, y10 = 0, y11 = 0, y12 = 0, y13 = 0, y14 = 0, y15 = 0, y16 = 1, y17 = 1, e1t = 0)
...
#plot(lambda, out[,'y16'])
plot(out[,'time'], out[,'y16'])
#plot(lambda, out[,'y17'])
plot(out[,'time'], out[,'y17'])
plot(out[,'e1t'], out[,'y14'])
